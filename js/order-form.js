 ...
 *  
 * @link       https://github.com/zachwatkins/tamus-order-plugin-wp/blob/master/js/order-form.js
...
(function ($) {
    ...
    var removeQuoteFieldset = function () {
        ...
        $form.find('.tamus-quote-item').each(
            function ( index ) {

                var $this = $(this);
                $this.attr('data-quote-index', index);

                $this.find('label[for="tamus_quote_"]').each(
                    function () {
                        this.for = this.for.replace(/\d+/, index);
                    }
                );

                $this.find('input[name="tamus_quote_"],textarea[name="tamus_quote_"]').each(
                    function () {
        ...
        $form.find('#list_purchases .quote-item').each(
            function ( index ) {
    ...
    var validateForm = function (e) {
        ...
        // Quote Items.
        $form.find('.tamus-quote-price,.tamus-quote-name,.tamus-quote-description,.tamus-quote-file').each(
            function () {
        ...
        $form.find('.tamus-quote-file').each(
            function () {
    ...
    function ajaxSubmit(e)
    {
        ...
        if (validation.status === true ) {
            ...
            var form_data = new FormData();
            $form.find('input:not([type="checkbox"]):not([type="file"]),select,textarea').each(
                function () {
