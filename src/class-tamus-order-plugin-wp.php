...
class Order
{
    ...
    public function __construct()
    {
        ...
        include_once TAMUS_ORDER_DIR_PATH . 'src/class-user-tamu.php';
        new \TAMUS\Order\User_Tamu();

        include_once TAMUS_ORDER_DIR_PATH . 'src/class-legacy-support.php';
        new \TAMUS\Order\Legacy_Support();

        // Modify the Dashboard widgets.
        include_once TAMUS_ORDER_DIR_PATH . 'src/class-dashboard.php';
        new \TAMUS\Order\Dashboard();

        // Load required JS and CSS.
        include_once TAMUS_ORDER_DIR_PATH . 'src/class-assets.php';
        new \TAMUS\Order\Assets();

        // Create post types.
        include_once TAMUS_ORDER_DIR_PATH . 'src/class-tamusorder-posttype.php';
        new \TAMUS\Order\TAMUS_Order_PostType();

        include_once TAMUS_ORDER_DIR_PATH . 'src/class-product-posttype.php';
        new \TAMUS\Order\Product_PostType();

        include_once TAMUS_ORDER_DIR_PATH . 'src/class-bundle-posttype.php';
        new \TAMUS\Order\Bundle_PostType();

        include_once TAMUS_ORDER_DIR_PATH . 'src/class-program-posttype.php';
        new \TAMUS\Order\Program_PostType();

        include_once TAMUS_ORDER_DIR_PATH . 'src/class-department-posttype.php';
        new \TAMUS\Order\Department_PostType();

        // Register page templates.
        include_once TAMUS_ORDER_DIR_PATH . 'src/class-pagetemplate.php';
    ...
    public function register_custom_fields()
    {
        ...
        if (function_exists('acf_add_options_page') ) {
            ...
            include_once TAMUS_ORDER_DIR_PATH . 'fields/settings-fields.php';
        ...
        include_once TAMUS_ORDER_DIR_PATH . 'fields/user-fields.php';
