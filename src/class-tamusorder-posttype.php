...
class TAMUS_Order_PostType
{
    ...
    public function __construct()
    {
        ...
        include_once TAMUS_ORDER_DIR_PATH . 'src/Post/class-emails.php';
    ...
    public function confirm_order()
    {
        ...
        if (current_user_can('wso_it_rep') ) {
            ...
            if (is_array($business_staff_status)
                && is_array($business_staff_status['business_staff'])
                && array_key_exists('ID', $business_staff_status['business_staff'])
                && $current_user_id === $business_staff_status['business_staff']['ID']
                && false === $business_staff_status['confirmed']
            ...
            if (is_array($it_logistics_status)
    ...
    private function can_current_user_update_order_public( $post_id )
    {
        ...
        } elseif ($customer_id !== $current_user_id
    ...
    private function can_current_user_update_order( $post_id )
    {
        ...
        } elseif (! current_user_can('wso_admin')
            && ! current_user_can('administrator')
            && 'returned' !== $post_status
        ) {
    ...
    public function register_post_type()
    {
        ...
        include_once TAMUS_ORDER_DIR_PATH . 'src/class-taxonomy.php';
    ...
    public function make_order()
    {
        ...
        if (isset($_POST['tamus_quote_count']) && 0 < intval($_POST['tamus_quote_count']) ) {
            ...
            if ($quote_count > 0 ) {
                ...
                include_once TAMUS_ORDER_DIR_PATH . '/src/class-order-form-helper.php';
        ...
        if (isset($_POST['tamus_quote_count']) && 0 < intval($_POST['tamus_quote_count']) ) {
            ...
            if ($quote_count > 0 ) {
                ...
                for ( $i = 0; $i < $quote_count; $i++ ) {
                    ...
                    if (isset($_POST[ "tamus_quote_{$i}_name" ])
    ...
    public function register_custom_fields()
    {
        ...
        include_once TAMUS_ORDER_DIR_PATH . 'fields/tamusorder-admin-fields.php';
        include_once TAMUS_ORDER_DIR_PATH . 'fields/tamusorder-fields.php';
        include_once TAMUS_ORDER_DIR_PATH . 'fields/tamusorder-return-to-user-fields.php';
        include_once TAMUS_ORDER_DIR_PATH . 'fields/order-department-comments-fields.php';
        include_once TAMUS_ORDER_DIR_PATH . 'fields/it-rep-status-order-fields.php';
        include_once TAMUS_ORDER_DIR_PATH . 'fields/business-staff-status-order-fields.php';
        include_once TAMUS_ORDER_DIR_PATH . 'fields/it-logistics-status-order-fields.php';
